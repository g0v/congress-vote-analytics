<?php
$issue_obj_by_id = Issue::find($issue_obj->id);
var_dump($issue_obj_by_id);
/*$avg_pro_score = round($issue_obj_by_id->getAVGProScore());
$avg_con_score = abs(round($issue_obj_by_id->getAVGConScore()));
?>
